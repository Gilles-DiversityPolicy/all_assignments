...
public class RMCmd {
	...
	while (argIndex < args.length) {
            ...
            boolean isRemoved =  hdfs.delete(new Path(args[argIndex]), (line.hasOption("r") || line.hasOption("R")));

	    if (isRemoved) System.out.println("Deleted " + args[argIndex]);

            if(!isRemoved && !line.hasOption("f")) System.out.println("rm: '"+args[argIndex]+"': No such file or directory");
